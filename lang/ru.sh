...
TXT_PANEL_ALREADY_INSTALLED="Панель управления TinoHost уже установлена, повторная установка невозможна"
TXT_SET_INSTALL_DIR="Укажите директорию для установки TinoHost (по умолчанию /opt): "
...
TXT_DOCKER_INSTALL_FAIL="Установка Docker не удалась\nВы можете попробовать установить Docker, используя оффлайн-пакет, обратитесь к следующей ссылке для подробных инструкций: https://docs.tinohost.com/installation/"
...
TXT_SET_PANEL_PORT="Укажите порт TinoHost (по умолчанию"
...
TXT_SET_PANEL_ENTRANCE="Установите безопасный вход TinoHost (по умолчанию"
...
TXT_SET_PANEL_USER="Установите пользователя панели TinoHost (по умолчанию"
...
TXT_SET_PANEL_PASSWORD="Установите пароль панели TinoHost, нажмите Enter после установки (по умолчанию"
TXT_INPUT_PASSWORD_RULE="Ошибка: Пароль панели поддерживает только буквы, цифры, специальные символы (!@#$%*_,.?), длина 8-30 символов"
TXT_CONFIGURE_PANEL_SERVICE="Настройка службы TinoHost"
TXT_START_PANEL_SERVICE="Запуск службы TinoHost"
TXT_SERVICE_RETRY_MSG="Ошибка запуска службы, повторная попытка..."
TXT_PANEL_SERVICE_START_SUCCESS="Служба TinoHost успешно запущена. Продолжается выполнение последующих настроек, пожалуйста, подождите..."
TXT_PANEL_SERVICE_START_ERROR="Ошибка запуска службы TinoHost!"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Официальный сайт: https://tinohost.com"
TXT_PROJECT_DOCUMENTATION="Документация проекта: https://docs.tinohost.com"
TXT_PROJECT_REPOSITORY="Репозиторий кода: https://github.com/TinoHost-dev/TinoHost"
TXT_COMMUNITY="Присоединяйтесь к сообществу TinoHost в Discord для поддержки и обсуждений: https://discord.gg/bUpUqWqdRr"
...
TXT_PANEL_SERVICE_STATUS="Проверить статус службы TinoHost"
TXT_PANEL_SERVICE_RESTART="Перезапустить службу TinoHost"
TXT_PANEL_SERVICE_STOP="Остановить службу TinoHost"
TXT_PANEL_SERVICE_START="Запустить службу TinoHost"
TXT_PANEL_SERVICE_UNINSTALL="Удалить службу TinoHost"
TXT_PANEL_SERVICE_USER_INFO="Получить информацию о пользователе TinoHost"
TXT_PANEL_SERVICE_LISTEN_IP="Переключить IP прослушивания TinoHost"
TXT_PANEL_SERVICE_VERSION="Получить информацию о версии TinoHost"
TXT_PANEL_SERVICE_UPDATE="Обновить системную информацию TinoHost"
TXT_PANEL_SERVICE_RESET="Сбросить системную информацию TinoHost"
TXT_PANEL_SERVICE_RESTORE="Восстановить службу и данные TinoHost"
TXT_PANEL_SERVICE_UNINSTALL_NOTICE="Удаление остановит и удалит службу TinoHost. Продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNINSTALL_START="Начало удаления панели управления сервером TinoHost для Linux"
TXT_PANEL_SERVICE_UNINSTALL_STOP="Остановка процессов службы TinoHost"
TXT_PANEL_SERVICE_UNINSTALL_REMOVE="Удаление исполняемых файлов TinoHost и связанных конфигураций службы"
...
TXT_PANEL_DATA_KEEP_PROMPT="Удалить каталог данных TinoHost? [y/n]: "
TXT_PANEL_DATA_KEEP="Сохранить каталог данных TinoHost"
TXT_PANEL_DATA_DELETE="Удалить каталог данных TinoHost"
TXT_PANEL_SERVICE_RESTORE_NOTICE="TinoHost будет восстановлен до последней стабильной версии. Хотите продолжить? [y/n]: "
TXT_PANEL_SERVICE_UNSUPPORTED_PARAMETER="Неподдерживаемые параметры, используйте help или --help для получения справки"
TXT_PANEL_CONTROL_SCRIPT="Скрипт управления TinoHost"
